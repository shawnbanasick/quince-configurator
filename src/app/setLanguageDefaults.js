...
const setLanguageDefaults = (language) => {
  ...
  if (language === "ko") {
    useStore.setState({
      ...
      mobileHeadersDefault7: "반대, 약간 반대, 약간 반대, 중립, 약간 동의, 동의, 동의",
      mobileHeadersDefault9:
  ...
  if (language === "zhHant") {
    useStore.setState({
      ...
      mobileHeadersDefault7: "反對, 有点反對, 有点反對, 中立, 有点賛成, 賛成, 賛成",
      mobileHeadersDefault9:
  ...
  if (language === "fr") {
    useStore.setState({
      mobileHeadersDefault5:
        "En contre, Un peu en contre, Neutre, Un peu à l'avantage, À l'avantage",
      mobileHeadersDefault7:
  ...
  if (language === "de") {
    useStore.setState({
      ...
      mobileHeadersDefault7: "Stark Gegen, Gegen, Enige Gegen, Neutral, Enige Für, Für, Stark Für",
      mobileHeadersDefault9:
