...
const setLanguageSection_DE = (language) => {
  ...
  welcomeText: "<h2>Quince Demoprojekt - iPad-Nutzung im Klassenzimmer.</h2><br/><br/><p>Vielen Dank für Ihre Unterstützung bei diesem Forschungsprojekt</p><br/><br/><br/> <center><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/lMy4ARVEcCI?rel=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></center>",
  landingHelpModalHead: "Willkommen!",
  landingHelpModalText: "Vielen Dank für Ihre Teilnahme an diesem universitären Forschungsprojekt. Bitte klicken Sie auf die Schaltfläche \"<b>Weiter</b>\" unten rechts auf dem Bildschirm, um zum nächsten Schritt zu gelangen.",
  btnNextLanding: "Weiter",
  btnHelpLanding: "Hilfe",
  mobileWelcomeText: "<h2>Quince Demoprojekt - iPad-Nutzung im Klassenzimmer.</h2><br/><br/><p>Vielen Dank für Ihre Unterstützung bei diesem Forschungsprojekt!</p><br/><br/><br/> <center><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/lMy4ARVEcCI?rel=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></center>",
  ...
  presortModalText: "Lesen Sie die folgenden Aussagen sorgfältig und teilen Sie sie in drei Stapel auf: einen Stapel für Aussagen, denen Sie tendenziell nicht zustimmen, einen Stapel für Karten, denen Sie tendenziell zustimmen, und einen Stapel für die übrigen. Änderungen können später vorgenommen werden.<br/><br/>Wenn Sie diese Anleitung ein zweites Mal lesen möchten, klicken Sie auf die Hilfe-Schaltfläche in der unteren linken Ecke.<br/><br/><center><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/vtnLuKzpcKQ?rel=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></center>",
  presortPreventNavModalHead: "Navigation deaktiviert",
  presortPreventNavModalText: "Bitte beenden Sie die Vorsortierung, bevor Sie zum nächsten Schritt übergehen.",
  presortFinishedModalHead: "Vorsortierung abgeschlossen",
  presortFinishedModalText: "Sie haben diesen Schritt abgeschlossen. Bitte klicken Sie auf die Schaltfläche \"Weiter\" unten rechts auf der Seite, um zum nächsten Schritt zu gelangen.",
  presortOnPageInstructions: "<div style=\"font-size: 24px\">Klicken und ziehen Sie die Karten oder drücken Sie die Tasten \"1\", \"2\" oder \"3\", um die Aussagen zu sortieren.</div>",
  presortImageSortInstructions: "Um ein Bild zu vergrößern, bewegen Sie Ihren Mauszeiger darüber und doppelklicken Sie. <br/><br/> Um Bilder zu vergleichen, <u>halten Sie</u> die <b><i>Shift</i></b>-Taste auf Ihrer Tastatur gedrückt und doppelklicken Sie dann mit Ihrer Maus auf ZWEI Bilder.",
  mobilePresortConditionsOfInstruction: "Bewerten Sie die Aussagen gemäß Ihrer Erfahrung mit der Nutzung der iPads im Unterricht",
  ...
  mobilePresortEvaluationsComplete: "<div><b>Alle Aussagen bewertet.</b> <br /><br />Bitte überprüfen Sie die Aussagen, um Ihre Bewertungen zu bestätigen.  <br /><br /><div>",
  ...
  thinningPreventNavModalText: "Bitte beenden Sie den Verfeinerungsprozess, bevor Sie zum nächsten Schritt übergehen.",
  thinningHelpModalHead: "Verfeinern Sie Ihre Bewertungen",
  thinningHelpModalText: "Bitte schauen Sie sich die Aussagen, die Sie in der vorherigen Phase bewertet haben, noch einmal an. Wählen Sie diejenigen aus, von denen Sie glauben, dass sie der beste Ausdruck Ihrer Perspektive sind.",
  ...
  initialInstructionPart1: "Unten sehen Sie die Aussagen, die Sie im vorherigen Schritt positiv bewertet haben. Wählen Sie nun die Anzahl der Aussagen aus, denen Sie <b>AM MEISTEN ZUSTIMMEN</b>.<br /><br />",
  initialInstructionPart2: "Wählen Sie als Nächstes weiterhin die Aussagen aus, die Ihrer Perspektive AM NÄCHSTEN kommen",
  initialInstructionPart3: "Nach dem Klicken auf die orange Schaltfläche \"Absenden\" wird eine weitere Reihe von Aussagen auf dem Bildschirm angezeigt.",
  initialInstructionPartNeg1: "Unten sehen Sie die Aussagen, die Sie im vorherigen Schritt positiv bewertet haben. Wählen Sie nun Aussagen aus, die sich <mark><b>AM MEISTEN VON IHRER PERSPEKTIVE UNTERSCHEIDEN</b></mark>.",
  initialInstructionPartNeg2: "Wählen Sie als Nächstes weiterhin die Aussagen aus, die sich <mark>AM MEISTEN</mark> von Ihrer Perspektive unterscheiden.",
  finalInstructions: "Verfeinerungsprozess abgeschlossen. Klicken Sie auf die Navigationsschaltfläche unten rechts, um zur nächsten Phase zu gelangen.",
  ...
  mobileThinHelpModalText: "In dieser Phase werden Sie gebeten, <b>die Aussagen</b> zu überprüfen, die Sie bewertet haben, und diejenigen auszuwählen, die Ihrer Perspektive am ähnlichsten oder am unterschiedlichsten sind.<br/><br/>Möglicherweise müssen Sie <b>nach unten scrollen</b>, um alle Aussagen zu sehen.<br/><br/>Um <b>eine Aussage auszuwählen</b>, tippen Sie auf den Aussagencontainer. Die Farbe der Aussage ändert sich zu gelb.<br/><br/>Wenn Sie die <b>richtige Anzahl</b> von Aussagen ausgewählt haben, ändert sich die Schaltfläche \"Absenden\" zu <b>blau</b>. <br/><br/>Um den Vergleich der Aussagen zu erleichtern, können Sie sie <b>neu anordnen</b>, indem Sie auf die Pfeile nach oben und unten tippen, die sich auf der rechten oder linken Seite der Aussage befinden.<br/><br/>Sie können auch <b>eine Gruppe</b> ausgewählter Aussagen an den Anfang der Liste verschieben, indem Sie auf den Pfeilen rechts neben einer Aussage <b>lange drücken</b> (etwa 1 Sekunde).",
  mobileThinPreventNavModalHead: "Navigation deaktiviert",
  mobileThinPreventNavModalText: "Bitte schließen Sie den Verfeinerungsprozess ab, bevor Sie zur nächsten Seite navigieren.",
  mobileThinProcessCompleteMessage: "Der Verfeinerungsprozess ist abgeschlossen. <br/><br/> Bitte klicken Sie auf die Navigationsschaltfläche unten rechts, um zur nächsten Phase zu gelangen.",
  mobileGuidanceModalRight1Header: "Phase 2 von 5<br/> Verfeinerungsprozess",
  mobileGuidanceModalRight1Text: "Diese Phase umfasst mehrere Schritte. <br/><br/>Schritt 1. Bitte betrachten Sie alle Aussagen, die Sie <b>positiv</b> bewertet haben, und wählen Sie diejenigen aus, die Ihrer Perspektive <b>am nächsten kommen</b>.<br/><br/>Möglicherweise müssen Sie nach unten <b>scrollen</b>, um alle Aussagen zu sehen.",
  mobileGuidanceModalRight2Header: "Phase 2 von 5<br/> Verfeinerungsprozess",
  mobileGuidanceModalRight2Text: "Als nächstes betrachten Sie erneut die verbleibenden Aussagen, die Sie <b>positiv</b> bewertet haben, und wählen Sie die <b>nächste Gruppe</b> von Aussagen aus, die Ihrer Perspektive <b>am nächsten kommen</b>.",
  mobileGuidanceModalLeft1Header: "Phase 2 von 5<br/> Verfeinerungsprozess",
  mobileGuidanceModalLeft1Text: "Schritt 2. Als nächstes betrachten Sie bitte alle Aussagen, die Sie negativ bewertet haben, und <b>wählen</b> Sie diejenigen aus, die sich <b>am stärksten</b> von Ihrer Perspektive <b>unterscheiden</b>.<br/><br/>Möglicherweise müssen Sie nach unten <b>scrollen</b>, um alle Aussagen zu sehen.",
  mobileGuidanceModalLeft2Header: "Phase 2 von 5<br/> Verfeinerungsprozess",
  mobileGuidanceModalLeft2Text: "Als nächstes betrachten Sie erneut die verbleibenden Aussagen, die Sie <b>negativ</b> bewertet haben, und <b>wählen</b> Sie die <b>nächste Gruppe</b> von Aussagen aus, die sich <b>am stärksten von Ihrer Perspektive unterscheiden</b>.",
  mobileThinScrollBottomModalHead: "Bestätigung deaktiviert",
  mobileThinScrollBottomModalText: "Bitte scrollen Sie nach unten und überprüfen Sie alle Aussagen, bevor Sie Ihre Auswahl bestätigen.",
  sortHelpModalHead: "Schritt 3 von 5",
  sortHelpModalText: "In diesem Schritt klicken Sie bitte auf die Aussagenkarten und ziehen Sie diese in die entsprechende Spalte, basierend auf Ihrer Perspektive und den Anweisungen des Forschers am oberen Rand der Seite. <br/><br/><center><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/iRxC9Vv3dLo?rel=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></center>",
  sortAgreement: "Zustimmung",
  sortDisagreement: "Ablehnung",
  condOfInst: "Sortieren Sie die Karten entsprechend Ihrer Erfahrung mit den iPads in diesem Semester",
  ...
  sortPreventNavModalText: "Bitte beenden Sie die Rastersortierung, bevor Sie zum nächsten Schritt gehen.",
  sortOverloadedColumnModalHead: "Navigation deaktiviert",
  sortOverloadedColumnModalText: "Eine der Spalten enthält zu viele Karten (sie wird orange umrandet und hat einen gestrichelten Rahmen). Bitte passen Sie die Platzierung der Karten so an, dass alle Spalten die korrekte Anzahl aufweisen.",
  ...
  postsortModalText: "Sie können die Schaltflächen am unteren Rand der Seite verwenden, um die Schriftgröße oder Kartenhöhe zu ändern.<br/><br/><center><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/EFNlSiaEVVg?rel=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></h3></center>",
  postsortPreventNavModalHead: "Navigation deaktiviert",
  postsortPreventNavModalText: "Bitte fügen Sie Kommentare zu allen Karten hinzu, bevor Sie zum nächsten Schritt gehen.",
  postsortBackButtonText: "Zurück",
  mobilePostsortPreventNavModalHead: "Navigation deaktiviert",
  mobilePostsortPreventNavModalText: "Bitte fügen Sie Kommentare zu allen Aussagen hinzu, bevor Sie zum nächsten Schritt gehen.",
  ...
  surveyModalText: "Bitte beantworten Sie abschließend die folgenden Fragen zu Ihrem Hintergrund. Die mit einem \"*\" im Titel gekennzeichneten Fragen sind Pflichtfragen.<br/><br/><center><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/68MHzgLn1zg?rel=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></center>",
  surveyPreventNavModalHead: "Navigation deaktiviert",
  surveyPreventNavModalText: "Bitte beantworten Sie die Pflichtfragen (gelb umrandet), bevor Sie zum nächsten Schritt gehen.",
  mobileSurveyHelpModalHead: "Phase 5 von 5<br/> Befragung nach der Rangfolge",
  mobileSurveyHelpModalText: "Bitte beantworten Sie diese Hintergrundfragen.<br/><br/>Bei einigen Fragen müssen Sie möglicherweise eine Antwort angeben, bevor Sie zum letzten Schritt gehen können.",
  btnTransfer: "Daten übermitteln",
  transferHead: "Letzter Schritt",
  transferTextAbove: "<h1>Bereit zur Übermittlung</h1><br/><br/> <h2>Bitte klicken Sie auf die Schaltfläche \"Daten übermitteln\", um Ihre Ergebnisse zu übertragen.</h2>",
  transferTextBelow: "Bitte warten Sie auf die Bestätigungsmeldung, die anzeigt, dass Ihre Daten erfolgreich an den Server gesendet wurden.",
  transferOkModalHeader: "Erfolg - Die Daten wurden an den Server gesendet.",
  transferOkModalText: "Vielen Dank, dass Sie Quince verwendet haben!<br/><br/>Sie können nun Ihren Browser-Tab schließen.",
  ...
  fallbackMessage: "*** Fehler - Übertragung fehlgeschlagen*** <br/><br/>Bitte überprüfen Sie Ihre Internetverbindung und klicken Sie erneut auf die Schaltfläche \"Daten übermitteln\".",
  btnDownload: "Herunterladen",
  goodbyeMessage: "<div>Vielen Dank!</div> <br /><div>Sie können nun den Browser-Tab schließen</div>",
  ...
  defaultEmailClientFail: "Ihr Standard-E-Mail-Client sollte automatisch mit den Ergebnissen im E-Mail-Text geöffnet worden sein. Falls nicht, verwenden Sie bitte die Schaltflächen unten, um Ihre Informationen zu kopieren und in eine E-Mail einzufügen.",
  emailBodyMessage: "Sie müssen dieser E-Mail nichts hinzufügen. Bitte klicken Sie einfach auf die SENDEN-Schaltfläche.",
  linkingFallbackMessage: "Bitte klicken Sie auf die Schaltfläche, um mit dem nächsten Q-Sort zu beginnen",
  ...
  localDeleteModalText: "Dies wird die Teilnehmer-Q-Sort-Daten löschen, die derzeit im Browser gespeichert sind. Dies würden Sie normalerweise nur tun, wenn Sie ein neues Projekt beginnen.<br/><br/><b>VORSICHT - Gelöschte Daten können nicht wiederhergestellt werden.</b> <br/><br/> <center></center>",
