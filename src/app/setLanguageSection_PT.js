...
const setLanguageSection_PT = (language) => {
  ...
  useStore.setState({
    ...
    welcomeText: "<h2>Projeto Demonstrativo Quince - Uso de iPad na Sala de Aula.</h2><br/><br/><p>Obrigado por ajudar com este projeto de pesquisa</p><br/>",
    ...
    mobileWelcomeText: "<h2>Projeto Demonstrativo Quince - Uso de iPad na Sala de Aula.</h2><br/><br/><p>Obrigado por ajudar com este projeto de pesquisa!</p><br/>",
    ...
    sortHelpModalText: "Neste passo, por favor, clique e arraste os cartões de afirmação para a coluna apropriada com base na sua perspectiva e nas instruções do pesquisador no topo da página. <br/>",
    ...
    postsortModalText: "Você pode usar os botões na parte inferior da página para alterar o tamanho da fonte ou a altura do cartão.<br/>",
    ...
    surveyModalText: "Finalmente, por favor, responda às seguintes perguntas sobre seu histórico. As perguntas marcadas com um \"*\" no título são obrigatórias.<br/>",
