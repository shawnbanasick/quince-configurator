...
const setLanguageSection_PT = (language) => {
  ...
  useStore.setState({
    ...
    btnNext: "Continuar",
    stepCompletedMessage: "Você concluiu esta etapa. Por favor, clique no <b>botão azul \"Continuar\"</b> no canto inferior direito da tela para ir para a próxima etapa.",
    ...
    welcomeText: "<h2>Projeto Demonstrativo Quince - Uso de iPad na Sala de Aula.</h2><br/><br/><p>Obrigado por ajudar com este projeto de pesquisa</p><br/><br/><br/> <center><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/lMy4ARVEcCI?rel=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></center>",
    landingHelpModalHead: "Bem-vindo!",
    landingHelpModalText: "Obrigado por participar deste Projeto de Pesquisa Universitária. Por favor, clique no botão \"<b>Continuar</b>\" no canto inferior direito da tela para ir para a próxima etapa.",
    btnNextLanding: "Continuar",
    btnHelpLanding: "Ajuda",
    mobileWelcomeText: "<h2>Projeto Demonstrativo Quince - Uso de iPad na Sala de Aula.</h2><br/><br/><p>Obrigado por ajudar com este projeto de pesquisa!</p><br/><br/><br/> <center><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/lMy4ARVEcCI?rel=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></center>",
    ...
    presortModalText: "Leia as seguintes afirmações cuidadosamente e divida-as em três pilhas: uma pilha para afirmações com as quais você tende a discordar, uma pilha para cartões com os quais você tende a concordar e uma pilha para o restante. As alterações podem ser feitas posteriormente.<br/><br/>Se você quiser ler esta instrução uma segunda vez, clique no botão de ajuda no canto inferior esquerdo.<br/><br/><center><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/vtnLuKzpcKQ?rel=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></center>",
    presortPreventNavModalHead: "Navegação Desabilitada",
    presortPreventNavModalText: "Por favor, termine a ordenação preliminar antes de ir para a próxima etapa.",
    presortFinishedModalHead: "Ordenação Preliminar Concluída",
    presortFinishedModalText: "Você concluiu esta etapa. Por favor, clique no botão \"Continuar\" no canto inferior direito da página para ir para a próxima etapa.",
    presortOnPageInstructions: "<div style=\"font-size: 24px\">Clique e arraste os cartões ou pressione as teclas \"1\", \"2\" ou \"3\" para ordenar as afirmações.</div>",
    presortImageSortInstructions: "Para ampliar uma imagem, posicione o ponteiro do mouse sobre ela e clique duas vezes. <br/><br/> Para comparar imagens, <u>pressione e segure</u> a tecla <b><i>Shift</i></b> no teclado e depois clique duas vezes em DUAS imagens com o mouse.",
    mobilePresortConditionsOfInstruction: "Avalie as Afirmações de Acordo com Sua Experiência de uso dos iPads na Aula",
    ...
    mobilePresortEvaluationsComplete: "<div><b>Todas as Afirmações Avaliadas.</b> <br /><br />Por favor, revise as afirmações para confirmar suas avaliações.  <br /><br /><div>",
    ...
    thinningPreventNavModalText: "Por favor, termine o processo de refinamento antes de ir para a próxima etapa.",
    thinningHelpModalHead: "Refine Suas Avaliações",
    thinningHelpModalText: "Por favor, observe novamente as afirmações que você avaliou na etapa anterior. Escolha aquelas que você sente que são a melhor expressão da sua perspectiva.",
    ...
    initialInstructionPart1: "Abaixo estão as afirmações que você avaliou positivamente na etapa anterior. Agora, escolha o número de afirmações com as quais você <b>MAIS CONCORDA</b>.<br /><br />",
    initialInstructionPart2: "Em seguida, continue a selecionar as afirmações que estão MAIS PRÓXIMAS da sua perspectiva",
    initialInstructionPart3: "Outro conjunto de afirmações aparecerá na tela depois que você clicar no botão laranja \"Enviar\".",
    initialInstructionPartNeg1: "Abaixo estão as afirmações que você avaliou positivamente na etapa anterior. Agora, escolha as afirmações que <mark><b>MAIS DIFEREM DA SUA PERSPECTIVA</b></mark>.",
    initialInstructionPartNeg2: "Em seguida, continue a selecionar as afirmações que <mark>MAIS DIFEREM</mark> da sua perspectiva.",
    finalInstructions: "Processo de refinamento concluído. Clique no botão de navegação no canto inferior direito para ir para a próxima etapa.",
    ...
    mobileThinHelpModalText: "Durante esta etapa, você será solicitado a <b>revisar as afirmações</b> que você avaliou e escolher aquelas que são mais similares ou mais diferentes da sua perspectiva.<br/><br/>Você pode precisar <b>rolar para baixo</b> para ver todas as afirmações.<br/><br/>Para <b>selecionar uma afirmação</b>, toque no contêiner da afirmação. A cor da afirmação mudará para amarelo.<br/><br/>Quando você tiver selecionado o <b>número correto</b> de afirmações, o botão \"Enviar\" mudará para <b>azul</b>. <br/><br/>Para facilitar a comparação das afirmações, você pode <b>reordená-las</b> tocando nas setas para cima e para baixo localizadas nos lados direito ou esquerdo da afirmação.<br/><br/>Você também pode <b>mover um grupo</b> de afirmações selecionadas para o topo da lista <b>pressionando longamente</b> (cerca de 1 segundo) nas setas à direita de uma afirmação.",
    mobileThinPreventNavModalHead: "Navegação Desabilitada",
    mobileThinPreventNavModalText: "Por favor, complete o processo de refinamento antes de navegar para a próxima página.",
    mobileThinProcessCompleteMessage: "O processo de refinamento está completo. <br/><br/> Por favor, clique no botão de navegação no canto inferior direito para ir para a próxima etapa.",
    mobileGuidanceModalRight1Header: "Etapa 2 de 5<br/> Processo de Refinamento",
    mobileGuidanceModalRight1Text: "Existem várias etapas nesta Fase. <br/><br/>Passo 1. Por favor, observe todas as afirmações que você avaliou <b>positivamente</b> e selecione aquelas que estão <b>mais próximas da sua perspectiva</b>.<br/><br/>Você pode precisar <b>rolar</b> para baixo para ver todas as afirmações.",
    mobileGuidanceModalRight2Header: "Etapa 2 de 5<br/> Processo de Refinamento",
    mobileGuidanceModalRight2Text: "Em seguida, mais uma vez observe as afirmações restantes que você avaliou <b>positivamente</b> e selecione o <b>próximo conjunto</b> de afirmações que estão <b>mais próximas da sua perspectiva</b>.",
    mobileGuidanceModalLeft1Header: "Etapa 2 de 5<br/> Processo de Refinamento",
    mobileGuidanceModalLeft1Text: "Passo 2. Em seguida, por favor, observe todas as afirmações que você avaliou negativamente e <b>selecione</b> aquelas que <b>diferem mais</b> da sua perspectiva.<br/><br/>Você pode precisar <b>rolar para baixo</b> para ver todas as afirmações.",
    mobileGuidanceModalLeft2Header: "Etapa 2 de 5<br/> Processo de Refinamento",
    mobileGuidanceModalLeft2Text: "Em seguida, mais uma vez observe as afirmações restantes que você avaliou <b>negativamente</b> e <b>selecione</b> o <b>próximo conjunto</b> de afirmações que são <b>mais diferentes da sua perspectiva</b>.",
    mobileThinScrollBottomModalHead: "Confirmação Desabilitada",
    mobileThinScrollBottomModalText: "Por favor, role até o final e revise todas as afirmações antes de confirmar suas seleções.",
    sortHelpModalHead: "Passo 3 de 5",
    sortHelpModalText: "Neste passo, por favor, clique e arraste os cartões de afirmação para a coluna apropriada com base na sua perspectiva e nas instruções do pesquisador no topo da página. <br/><br/><center><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/iRxC9Vv3dLo?rel=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></center>",
    ...
    sortingCompleteModalText: "Você completou a ordenação inicial. Por favor, reserve um momento para confirmar a colocação dos cartões.<br/><br/>Quando estiver satisfeito com a colocação deles, por favor, clique no <b>botão azul \"Continuar\"</b> no canto inferior direito da sua tela para ir para o próximo passo.",
    sortPreventNavModalHead: "Navegação Desabilitada",
    sortPreventNavModalText: "Por favor, termine a ordenação da grade antes de ir para o próximo passo.",
    sortOverloadedColumnModalHead: "Navegação Desabilitada",
    sortOverloadedColumnModalText: "Uma das colunas tem muitos cartões (ela será destacada em laranja e terá uma borda tracejada). Por favor, ajuste a colocação dos cartões para que todas as colunas tenham o número correto.",
    ...
    mobileSortConditionsOfInstruction: "Classifique as Afirmações de Acordo com Sua Experiência de Uso dos iPads na Aula",
    ...
    mobileSortScrollBottomModalText: "Por favor, role até o final e revise a classificação de todas as afirmações antes de ir para a próxima etapa.",
    postsortHeader: "Comentários Pós-Ordenação",
    postsortInstructions: "<h3>Por favor, descreva seus pensamentos sobre estas afirmações com mais detalhes.</h3>",
    ...
    postsortModalText: "Você pode usar os botões na parte inferior da página para alterar o tamanho da fonte ou a altura do cartão.<br/><br/><center><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/EFNlSiaEVVg?rel=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></h3></center>",
    postsortPreventNavModalHead: "Navegação Desabilitada",
    postsortPreventNavModalText: "Por favor, adicione comentários a todos os cartões antes de ir para o próximo passo.",
    postsortBackButtonText: "Voltar",
    mobilePostsortPreventNavModalHead: "Navegação Desabilitada",
    mobilePostsortPreventNavModalText: "Por favor, adicione comentários a todas as afirmações antes de ir para o próximo passo.",
    ...
    surveyModalText: "Finalmente, por favor, responda às seguintes perguntas sobre seu histórico. As perguntas marcadas com um \"*\" no título são obrigatórias.<br/><br/><center><iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/68MHzgLn1zg?rel=0\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></center>",
    surveyPreventNavModalHead: "Navegação Desabilitada",
    surveyPreventNavModalText: "Por favor, responda às perguntas obrigatórias (destacadas em amarelo) antes de ir para o próximo passo.",
    mobileSurveyHelpModalHead: "Etapa 5 de 5<br/> Questionário Pós-Classificação",
    mobileSurveyHelpModalText: "Por favor, responda a estas perguntas de histórico.<br/><br/>Algumas das perguntas podem exigir que você forneça uma resposta antes de poder ir para o passo final.",
    btnTransfer: "Enviar Dados",
    transferHead: "Passo Final",
    transferTextAbove: "<h1>Pronto para Enviar</h1><br/><br/> <h2>Por favor, clique no botão \"Enviar Dados\" para transmitir seus resultados.</h2>",
    transferTextBelow: "Por favor, aguarde a mensagem de confirmação que indica que seus dados foram enviados ao servidor com sucesso.",
    transferOkModalHeader: "Sucesso - Os dados foram enviados ao servidor.",
    transferOkModalText: "Obrigado por usar Quince!<br/><br/>Você pode agora fechar a aba do seu navegador.",
    ...
    fallbackMessage: "*** Erro - Falha na Transmissão*** <br/><br/>Por favor, verifique sua conexão com a internet e clique no botão \"Enviar Dados\" novamente.",
    btnDownload: "Baixar",
    goodbyeMessage: "<div>Obrigado!</div> <br /><div>Você pode agora fechar a aba do navegador</div>",
    ...
    defaultEmailClientFail: "Seu cliente de email padrão deveria ter aberto automaticamente com os resultados no corpo do email. Se não abriu, por favor, use os botões abaixo para copiar e colar suas informações em um email.",
    emailBodyMessage: "Você não precisa adicionar nada a este email. Por favor, apenas clique no botão ENVIAR.",
    ...
    localDeleteModalText: "Isto excluirá os dados da ordenação Q do participante que estão atualmente armazenados no navegador. Você normalmente faria isso apenas ao iniciar um novo projeto.<br/><br/><b>ATENÇÃO - Dados excluídos não podem ser recuperados.</b> <br/><br/> <center></center>",
