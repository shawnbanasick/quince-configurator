...
const Config10PostsortOptions: React.FC = () => {
  ...
  const handleShowPostsortChange = (
  ...
  const handleShowSecondPosColumnChange = (
    input: React.ChangeEvent<HTMLInputElement>
  ) => {
    console.log(input.target.value);
    if (input.target.value === "true") {
  ...
  const handleShowSecondNegColumnChange = (
    input: React.ChangeEvent<HTMLInputElement>
  ) => {
    console.log(input.target.value);
    if (input.target.value === "true") {
  ...
  const handleShowBackButtonChange = (
    input: React.ChangeEvent<HTMLInputElement>
  ) => {
    console.log(input.target.value);
    if (input.target.value === "true") {
  ...
  const handlePostsortCommentsRequiredChange = (
    input: React.ChangeEvent<HTMLInputElement>
  ) => {
    console.log(input.target.value);
    if (input.target.value === "true") {
  ...
  return (
    <div className="flex flex-col  pt-6 pb-2 hover:bg-gray-100 hover:outline outline-2 outline-zinc-600 p-2 hover:rounded-md">
      ...
      <div className="flex flex-row h-[60px] content-center gap-5 mt-3">
        <span className="content-center">{`10b. ${t(
          "showSecondPosColumn"
        )}:`}</span>
        <div className="content-center">
          <label
      ...
      <div className="flex flex-row h-[60px] content-center gap-5 mt-3">
        <span className="content-center">{`10c. ${t(
          "showSecondNegColumn"
        )}:`}</span>
        <div className="content-center">
          <label
      ...
      <div className="flex flex-row h-[60px] content-center gap-5 mt-3">
        <span className="content-center">{`10e. ${t(
