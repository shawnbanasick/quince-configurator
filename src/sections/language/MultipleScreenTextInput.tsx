...
const MultipleScreenTextInput = () => {
  ...
  return (
    <div className="outline outline-2 outline-slate-500  p-2 w-[100%]  rounded-sm">
      ...
      <div className="pl-10">
        <UserTextInput
          classNameText={`flex-1 mt-1 block w-[100%] min-w-[200px] ml-2 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-blue-500 focus:outline-2 select-none sm:text-sm disabled:opacity-50 font-normal`}
