...
const PostsortTextInput: React.FC = () => {
  ...
  const setPostsortInstructions = useStore(
    (state) => state.setPostsortInstructions
  );
  ...
  const setPostsortDisagreement = useStore(
    (state) => state.setPostsortDisagreement
  );
  ...
  const postsortPreventNavModalHead = useStore(
    (state) => state.postsortPreventNavModalHead
  );
  const setPostsortPreventNavModalHead = useStore(
    (state) => state.setPostsortPreventNavModalHead
  );

  const postsortPreventNavModalText = useStore(
    (state) => state.postsortPreventNavModalText
  );
  const setPostsortPreventNavModalText = useStore(
    (state) => state.setPostsortPreventNavModalText
  );

  const postsortBackButton = useStore((state) => state.postsortBackButton);
  const setPostsortBackButton = useStore(
    (state) => state.setPostsortBackButton
  );
