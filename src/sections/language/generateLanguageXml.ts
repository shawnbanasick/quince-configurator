...
const generateLanguageXml = () => {
  ...
  let data = `<?xml version="1.0" encoding="UTF-8"?>
   ...
   <language version="${useStore.getState().version}" htmlParse="true">;
       ...
       <!-- 2. PREVENT MOBILE ACCESS SCREEN -->
       <item order= "2-1" id="preventMobileTitle">${encodeHTML(
         useStore.getState().preventMobileTitle,
       )}</item>
       <item order= "2-2" id="preventMobileMessage">${encodeHTML(
         useStore.getState().preventMobileMessage,
       )}</item>
        
        <!-- 3. CONSENT SCREEN -->
        <item order= "3-1" id="consentTitleBarText">${encodeHTML(
          useStore.getState().consentTitleBarText,
        )}</item>
        <item order= "3-2" id="consentText">${encodeHTML(useStore.getState().consentText)}</item>
        <item order= "3-3" id="consentHelpModalHead">${encodeHTML(
          useStore.getState().consentHelpModalHead,
        )}</item>
        <item order= "3-4" id="consentHelpModalText">${encodeHTML(
          useStore.getState().consentHelpModalText,
        )}</item>
        <item order= "3-5" id="btnHelpConsent">${encodeHTML(
          useStore.getState().btnHelpConsent,
        )}</item>
        <item order= "3-6" id="btnNextConsent">${encodeHTML(
          useStore.getState().btnNextConsent,
        )}</item>

        <!-- 4. ACCESS CONTROL - only displayed if access is restricted -->
        <item order= "4-1" id="loginWelcomeText">${encodeHTML(
          useStore.getState().loginWelcomeText,
        )}</item>
        <item order= "4-2" id="loginHeaderText">${encodeHTML(
          useStore.getState().loginHeaderText,
        )}</item>
        <item order= "4-3" id="loginPartIdText">${encodeHTML(
          useStore.getState().loginPartIdText,
        )}</item>
        <item order= "4-4" id="accessCodeText">${encodeHTML(
          useStore.getState().accessCodeText,
        )}</item>
        <item order= "4-5" id="accessInputText">${encodeHTML(
          useStore.getState().accessInputText,
        )}</item>
        <item order= "4-6" id="partIdWarning">${encodeHTML(
          useStore.getState().partIdWarning,
        )}</item>
        <item order= "4-7" id="accessCodeWarning">${encodeHTML(
          useStore.getState().accessCodeWarning,
        )}</item>
        <item order= "4-8" id="loginSubmitButtonText">${encodeHTML(
          useStore.getState().loginSubmitButtonText,
        )}</item>
        
        <!-- 5. WELCOME (LANDING) SCREEN -->
        <item order= "5-1" id="landingHead">${encodeHTML(useStore.getState().landingHead)}</item>
        <item order= "5-2" id="welcomeText">${encodeHTML(
          useStore.getState().welcomeText,
        )}</item>        
        <item order= "5-3" id="landingHelpModalHead">${encodeHTML(
          useStore.getState().landingHelpModalHead,
        )}</item>
        <item order= "5-4" id="landingHelpModalText">${encodeHTML(
          useStore.getState().landingHelpModalText,
        )}</item>
        <item order= "5-5" id="btnHelpLanding">${encodeHTML(
          useStore.getState().btnHelpLanding,
        )}</item>
        <item order= "5-6" id="btnNextLanding">${encodeHTML(
          useStore.getState().btnNextLanding,
        )}</item>

        <!-- 6. MOBILE WELCOME (LANDING) SCREEN -->
        <item order= "6-1" id="mobileWelcomeText">${encodeHTML(
          useStore.getState().mobileWelcomeText,
        )}</item>

        <!-- 7. PRESORT: rough sorting into three piles -->
        <item order= "7-1" id="logInFirst">${encodeHTML(useStore.getState().logInFirst)}</item>
        <item order= "7-2" id="titleBarText">${encodeHTML(useStore.getState().titleBarText)}</item>
        ...
        <item order= "7-7" id="presortOnPageInstructions">${encodeHTML(
          useStore.getState().presortOnPageInstructions,
        )}</item>
        <item order= "7-8" id="presortModalHead">${encodeHTML(
          useStore.getState().presortModalHead,
        )}</item>
        <item order= "7-9" id="presortModalText">${encodeHTML(
          useStore.getState().presortModalText,
        )}</item>
        <item order= "7-10" id="presortPreventNavModalHead">${encodeHTML(
          useStore.getState().presortPreventNavModalHead,
        )}</item>
        <item order= "7-11" id="presortPreventNavModalText">${encodeHTML(
          useStore.getState().presortPreventNavModalText,
        )}</item>
        <item order= "7-12" id="presortFinishedModalHead">${encodeHTML(
          useStore.getState().presortFinishedModalHead,
        )}</item>
        <item order= "7-13" id="presortFinishedModalText">${encodeHTML(
          useStore.getState().presortFinishedModalText,
        )}</item>
        <item order= "7-14" id="presortImageSortInstructions">${encodeHTML(
          useStore.getState().presortImageSortInstructions,
        )}</item>        

        <!-- 8. MOBILE PRESORT -->
        <item order= "8-1" id="mobilePresortHelpModalHead">${encodeHTML(
          useStore.getState().mobilePresortHelpModalHead,
        )}</item>
        <item order= "8-2" id="mobilePresortHelpModalText">${encodeHTML(
          useStore.getState().mobilePresortHelpModalText,
        )}</item>
        <item order= "8-3" id="mobilePresortConditionsOfInstruction">${encodeHTML(
          useStore.getState().mobilePresortConditionsOfInstruction,
        )}</item>
        <item order= "8-4" id="mobilePresortCompletedLabel">${encodeHTML(
          useStore.getState().mobilePresortCompletedLabel,
        )}</item>
        <item order= "8-5" id="mobilePresortAssignLeft">${encodeHTML(
          useStore.getState().mobilePresortAssignLeft,
        )}</item>
        <item order= "8-6" id="mobilePresortAssignRight">${encodeHTML(
          useStore.getState().mobilePresortAssignRight,
        )}</item>
        <item order= "8-7" id="mobilePresortRedoModalHead">${encodeHTML(
          useStore.getState().mobilePresortRedoModalHead,
        )}</item>
        <item order= "8-8" id="mobilePresortRedoModalConfirmButton">${encodeHTML(
          useStore.getState().mobilePresortRedoModalConfirmButton,
        )}</item>
        <item order= "8-9" id="mobilePresortEvaluationsComplete">${encodeHTML(
          useStore.getState().mobilePresortEvaluationsComplete,
        )}</item>
        <item order= "8-10" id="mobilePresortFinishedModalHead">${encodeHTML(
          useStore.getState().mobilePresortFinishedModalHead,
        )}</item>
        <item order= "8-11" id="mobilePresortFinishedModalText">${encodeHTML(
          useStore.getState().mobilePresortFinishedModalText,
        )}</item>
        <item order= "8-12" id="mobilePresortPreventNavModalHead">${encodeHTML(
          useStore.getState().mobilePresortPreventNavModalHead,
        )}</item>
        <item order= "8-13" id="mobilePresortPreventNavModalText">${encodeHTML(
          useStore.getState().mobilePresortPreventNavModalText,
        )}</item>      
        <item order= "8-14" id="mobilePresortProcessCompleteMessage">${encodeHTML(
          useStore.getState().mobilePresortProcessCompleteMessage,
        )}</item>      
             

        <!-- 9. THINNING -->
        <item order= "9-1" id="thinningHelpModalHead">${encodeHTML(
          useStore.getState().thinningHelpModalHead,
        )}</item>
         <item order= "9-2" id="thinningHelpModalText">${encodeHTML(
           useStore.getState().thinningHelpModalText,
         )}</item>
         <item order= "9-3" id="thinPageTitle">${encodeHTML(
           useStore.getState().thinPageTitle,
         )}</item>
         <item order= "9-4" id="thinPageSubmitButton">${encodeHTML(
           useStore.getState().thinPageSubmitButton,
         )}</item>
         <item order= "9-5" id="numStatementsToSelect">${encodeHTML(
           useStore.getState().numStatementsToSelect,
         )}</item>
         <item order= "9-6" id="currentlySelectedNumber">${encodeHTML(
           useStore.getState().currentlySelectedNumber,
         )}</item>
         <item order= "9-7" id="initialInstructionPart1">${encodeHTML(
           useStore.getState().initialInstructionPart1,
         )}</item>
         <item order= "9-8" id="initialInstructionPart2">${encodeHTML(
           useStore.getState().initialInstructionPart2,
         )}</item>
         <item order= "9-9" id="initialInstructionPart3">${encodeHTML(
           useStore.getState().initialInstructionPart3,
         )}</item>
         <item order= "9-10" id="initialInstructionPartNeg1">${encodeHTML(
           useStore.getState().initialInstructionPartNeg1,
         )}</item>
         <item order= "9-11" id="initialInstructionPartNeg2">${encodeHTML(
           useStore.getState().initialInstructionPartNeg2,
         )}</item>
         <item order= "9-12" id="finalInstructions">${encodeHTML(
           useStore.getState().finalInstructions,
         )}</item>
         <item order= "9-13" id="thinningPreventNavModalHead">${encodeHTML(
           useStore.getState().thinningPreventNavModalHead,
         )}</item>
         <item order= "9-14" id="thinningPreventNavModalText">${encodeHTML(
           useStore.getState().thinningPreventNavModalText,
         )}</item>
         
        <!-- 10. MOBILE THINNING -->
        <item order="10-1" id="mobileThinHelpModalHead">${encodeHTML(
          useStore.getState().mobileThinHelpModalHead,
        )}</item>
        <item order="10-2" id="mobileThinHelpModalText">${encodeHTML(
        ...
        <item order="11-2" id="sortHelpModalText">${encodeHTML(
          useStore.getState().sortHelpModalText,
        )}</item>
        <item order="11-3"  id="sortAgreement">${encodeHTML(
          useStore.getState().sortAgreement,
        )}</item>
        <item order="11-4" id="sortDisagreement">${encodeHTML(
          useStore.getState().sortDisagreement,
        )}</item>
        <item order="11-5" id="condOfInst">${encodeHTML(useStore.getState().condOfInst)}</item>
        <item order="11-6" id="sortOverloadedColumnModalHead">${encodeHTML(
          useStore.getState().sortOverloadedColumnModalHead,
        )}</item>
        <item order="11-7" id="sortOverloadedColumnModalText">${encodeHTML(
          useStore.getState().sortOverloadedColumnModalText,
        )}</item>

        <!-- 12. MOBILE SORT -->
        <item order="12-1" id="mobileSortHelpModalHead">${encodeHTML(
          useStore.getState().mobileSortHelpModalHead,
        )}</item>
        <item order="12-2" id="mobileSortHelpModalText">${encodeHTML(
          useStore.getState().mobileSortHelpModalText,
        )}</item>
        <item order="12-3" id="mobileSortConditionsOfInstruction">${encodeHTML(
          useStore.getState().mobileSortConditionsOfInstruction,
        )}</item>
        <item order="12-4" id="mobileSortScrollBottomModalHead">${encodeHTML(
          useStore.getState().mobileSortScrollBottomModalHead,
        )}</item>
        <item order="12-5" id="mobileSortScrollBottomModalText">${encodeHTML(
          useStore.getState().mobileSortScrollBottomModalText,
        )}</item>
        <item order="12-6" id="mobileSortSwapModalHead">${encodeHTML(
          useStore.getState().mobileSortSwapModalHead,
        )}</item>
        <item order="12-7" id="mobileSortSwapModalConfirmButton">${encodeHTML(
          useStore.getState().mobileSortSwapModalConfirmButton,
        )}</item>
        <item order="12-8" id="mobileSortSwapModalSuccessMessage">${encodeHTML(
          useStore.getState().mobileSortSwapModalSuccessMessage,
        )}</item>

       <!-- 13. POSTSORT: comments - only displayed if showStep3 = TRUE in config.xml -->
       <item order="13-1" id="postsortModalHead">${encodeHTML(
         useStore.getState().postsortModalHead,
       )}</item>
       <item order="13-2" id="postsortModalText">${encodeHTML(
         useStore.getState().postsortModalText,
       )}</item>
       <item order="13-3" id="postsortHeader">${encodeHTML(
         useStore.getState().postsortHeader,
       )}</item>
       <item order="13-4" id="postsortInstructions">${encodeHTML(
        ...
        <item order="13-8" id="postsortDisagreement">${encodeHTML(
          useStore.getState().postsortDisagreement,
        )}</item>
        <item order="13-9" id="postsortBackButtonText">${encodeHTML(
          useStore.getState().postsortBackButtonText,
        )}</item>
        <item order="13-10" id="postsortPreventNavModalHead">${encodeHTML(
          useStore.getState().postsortPreventNavModalHead,
        )}</item>
        <item order="13-11" id="postsortPreventNavModalText">${encodeHTML(
          useStore.getState().postsortPreventNavModalText,
        )}</item>


       <!-- 14. MOBILE POSTSORT: comments - only displayed if showStep3 = TRUE in config.xml -->
       <item order="14-1" id="mobilePostsortHelpModalHead">${encodeHTML(
         useStore.getState().mobilePostsortHelpModalHead,
       )}</item>
       <item order="14-2" id="mobilePostsortHelpModalText">${encodeHTML(
         useStore.getState().mobilePostsortHelpModalText,
       )}</item>
       <item order="14-3" id="mobilePostsortSortbarText">${encodeHTML(
         useStore.getState().mobilePostsortSortbarText,
       )}</item>
       <item order="14-4" id="mobilePostsortPlaceholder">${encodeHTML(
         useStore.getState().mobilePostsortPlaceholder,
       )}</item>
       <item order="14-5" id="mobilePostsortPreventNavModalHead">${encodeHTML(
         useStore.getState().mobilePostsortPreventNavModalHead,
       )}</item>
       <item order="14-6" id="mobilePostsortPreventNavModalText">${encodeHTML(
         useStore.getState().mobilePostsortPreventNavModalText,
       )}</item>
       
        <!-- 15. SURVEY: Additional questions, only displayed if showStep4 == TRUE -->
        <item order="15-1" id="surveyModalHead">${encodeHTML(
          useStore.getState().surveyModalHead,
        )}</item>
        <item order="15-2" id="surveyModalText">${encodeHTML(
          useStore.getState().surveyModalText,
        )}</item>
        <item order="15-3" id="surveyHeader">${encodeHTML(useStore.getState().surveyHeader)}</item>
        <item order="15-4" id="surveyPreventNavModalHead">${encodeHTML(
          useStore.getState().surveyPreventNavModalHead,
        )}</item>
        <item order="15-5" id="surveyPreventNavModalText">${encodeHTML(
          useStore.getState().surveyPreventNavModalText,
        )}</item>

        <!-- 16. MOBILE SURVEY: Additional questions, only displayed if showStep4 == true -->
        <item order="16-1" id="mobileSurveyHelpModalHead">${encodeHTML(
          useStore.getState().mobileSurveyHelpModalHead,
        )}</item>
        <item order="16-2" id="mobileSurveyHelpModalText">${encodeHTML(
          useStore.getState().mobileSurveyHelpModalText,
        )}</item>

        <!-- 17. SUBMIT -->
        <item order="17-1" id="btnTransfer">${encodeHTML(useStore.getState().btnTransfer)}</item>
        <item order="17-2" id="transferHead">${encodeHTML(useStore.getState().transferHead)}</item>
        <item order="17-3" id="transferTextAbove">${encodeHTML(
          useStore.getState().transferTextAbove,
        )}</item>
        <item order="17-4" id="transferTextBelow">${encodeHTML(
          useStore.getState().transferTextBelow,
        )}</item>
        <item order="17-5" id="transferOkModalHeader">${encodeHTML(
          useStore.getState().transferOkModalHeader,
        )}</item>   
        <item order="17-6" id="transferOkModalText">${encodeHTML(
          useStore.getState().transferOkModalText,
        )}</item>
        <item order="17-7" id="transferFailModalHeader">${encodeHTML(
          useStore.getState().transferFailModalHeader,
        )}</item>   
        <item order="17-8" id="transferFailModalText">${encodeHTML(
          useStore.getState().transferFailModalText,
        )}</item>   
        <item order="17-9" id="fallbackMessage">${encodeHTML(
          useStore.getState().fallbackMessage,
        )}</item>   
        <item order="17-10" id="btnDownload">${encodeHTML(
          useStore.getState().btnDownload,
        )}</item>   
        <item order="17-11" id="goodbyeMessage">${encodeHTML(
          useStore.getState().goodbyeMessage,
        )}</item>   

        <!-- 18. MOBILE SUBMIT -->
        <item order="18-1" id="mobileSortTitleBar">${encodeHTML(
          useStore.getState().mobileSortTitleBar,
        )}</item>

        <!-- 19. EMAIL -->
        <item order="19-1" id="checkInternetMessage">${encodeHTML(
          useStore.getState().checkInternetMessage,
        )}</item>
        <item order="19-2" id="btnTransferEmail">${encodeHTML(
          useStore.getState().btnTransferEmail,
        )}</item>
        <item order="19-3" id="submitFailMessage">${encodeHTML(
          useStore.getState().submitFailMessage,
        )}</item>  
        <item order="19-4" id="defaultEmailClientFail">${encodeHTML(
          useStore.getState().defaultEmailClientFail,
        )}</item>   
        <item order="19-5" id="clipboardEmail">${encodeHTML(
          useStore.getState().clipboardEmail,
        )}</item>  
        <item order="19-6" id="clipboardResults">${encodeHTML(
          useStore.getState().clipboardResults,
        )}</item>  
        <item order="19-7" id="copiedText">${encodeHTML(useStore.getState().copiedText)}</item>  
        ...
        <!-- 20. LINKING -->
        <item order="20-1" id="linkedProjectMessage">${encodeHTML(
          useStore.getState().linkingFallbackMessage,
        )}</item>   
         <item order="20-2" id="linkedProjectBtnMessage">${encodeHTML(
           useStore.getState().linkingBtnText,
         )}</item>   

        <!-- 21. LOCAL DATA COLLECTION -->  
        <item order="21-1" id="localHeader">${encodeHTML(useStore.getState().localHeader)}</item>
        <item order="21-2" id="partIdText">${encodeHTML(useStore.getState().partIdText)}</item>
        <item order="21-3" id="usercodeText">${encodeHTML(useStore.getState().usercodeText)}</item>
        <item order="21-4" id="localStartButtonText">${encodeHTML(
          useStore.getState().localStartButtonText,
        )}</item>
        <item order="21-5" id="localDeleteButtonText">${encodeHTML(
          useStore.getState().localDeleteButtonText,
        )}</item>
        <item order="21-6" id="localDownloadButtonText">${encodeHTML(
          useStore.getState().localDownloadButtonText,
        )}</item>
        <item order="21-7" id="storedQsortsHeaderText">${encodeHTML(
          useStore.getState().storedQsortsHeaderText,
        )}</item>
        <item order="21-8" id="localDeleteModalHead">${encodeHTML(
          useStore.getState().localDeleteModalHead,
        )}</item>
        <item order="21-9" id="localDeleteModalText">${encodeHTML(
          useStore.getState().localDeleteModalText,
        )}</item>
        <item order="21-10" id="localParticipantsText">${encodeHTML(
          useStore.getState().localParticipantsText,
        )}</item>
        <item order="21-11" id="localSaveDataButton">${encodeHTML(
          useStore.getState().localSaveDataButton,
        )}</item>
        <item order="21-12" id="localSubmitSuccessModalHeader">${encodeHTML(
          useStore.getState().localSubmitSuccessModalHeader,
        )}</item>
        <item order="21-13" id="localSubmitSuccessModalText">${encodeHTML(
          useStore.getState().localSubmitSuccessModalText,
        )}</item>
        <item order="21-14" id="localSaveBeforeDeleteModalHeader">${encodeHTML(
          useStore.getState().localSaveBeforeDeleteModalHeader,
        )}</item>
        <item order="21-15" id="localSaveBeforeDeleteModalText">${encodeHTML(
          useStore.getState().localSaveBeforeDeleteModalText,
        )}</item>
        <item order="21-16" id="returnToLocalPanelButtonText">${encodeHTML(
