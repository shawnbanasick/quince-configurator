    ...
    <div className="flex flex-col items-center justify-center">
      {displayMode && (
        ...
        <div className=" ml-[10px] mt-[40px] mb-[30px] w-[78vw] max-w-[1200px] text-[20px] p-[10px] bg-[whitesmoke] rounded-[3px] border-2 border-black">
          ...
          <br />
          <br />
          If you want to create new statements, you can type them directly into the text box below,
          or paste statements from another file. Each statement must be on a new line.
          <br />
          <br />
          ...
          <br />
          After you have finished adding or modifying your statements, you must save the file. click
          the orange button at the top right side of the page and save your information as
          'statements.xml' in the settings folder (replacing the default file).
        </div>
      )}
